                    ...
                    <?php if($resultCheck > 0): ?>
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <div class = "order_list_row">
                                ...
                                <a class = "order_list_button" href="total_orders_process.php?d`elete=<?php echo $row['id']; ?>" class="delete_button">Delete</a>
                                <a class="order_list_button" href="total_orders_process.php?cancel=<?php echo $row['id']; ?>">Cancel</a>
