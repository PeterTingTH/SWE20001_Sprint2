...
<body>
    <header>
        <div class="logo">
        <img src="images/logo.png" alt="logo" class="online_logo">
         </div>
    </header>
...
<article>
    <div class ="container">
        <div class ="container1">
            ...
            <h2>We've received your order and will contact you as soon as your package is shipped. You can find your purchase information below.</h2>
        </div>
    </div>
    ...
    <div class ="product">
        <img src="images/Moist-Chicken-Burgers.jpg" alt="food" class="food_pic">
        ...
        <div class ="product_list">
            <div class ="product_listing">
                ...
                <div class ="product_listing_menu1">
                    <p>Product ID <br>
                    Vendor <br>
                    Quantity
            ...
            <div class="billing">
                    <div class="billing_shipping">
                        <p><strong>Billing</strong> <br>
                            James Lau Yii Xiang <br>
                            No.68, Lorong 16A, Jalan Stutong <br>
                            93000 Kuching <br>
                            Sarawak <br>
                            Malaysia
                        </p>
                        ...
                        <p><strong>Shipping</strong> <br>
                            James Lau xiang Ying <br>
                            No.88, Lorong 14A, Jalan Simpang Tiga <br>
                            93000 Kuching <br>
                            Sarawak <br>
                            Malaysia
                        </p>
