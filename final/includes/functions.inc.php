...
function foodExists($conn, $foodID){
...
function sendVKey($email, $vkey){
    ...
    <br><a href='http://localhost/final/includes/verify.inc.php?vkey=$vkey'>Click here to activate your account!</a>
    <br><a href='http://localhost/final/includes/verify.inc.php?vkey=$vkey&delete=true'>Click here if this is not you.</a>
    ";
...
function sendPasswordKey($email,$passResetKey){
    ...
    $mail->Body = "
    <br><a href='http://localhost/final/includes/checkResetKey.inc.php?passResetKey=$passResetKey'>Click here to reset your password!</a>
    <br><a href='http://localhost/final/includes/checkResetKey.inc.php?passResetKey=$passResetKey&delete=true'>Click here if you did not ask for this.</a>
    ";
...
function sendDeleteKey($email,$deleteAccKey){
    ...
    $mail->Body = "
    <br><a href='http://localhost/final/includes/checkDeleteKey.inc.php?deleteAccKey=$deleteAccKey'>Click here to confirm delete your account!</a>
    <br><a href='http://localhost/final/includes/checkDeleteKey.inc.php?deleteAccKey=$deleteAccKey&delete=true'>Click here if you did not ask for this.</a>
    ";
